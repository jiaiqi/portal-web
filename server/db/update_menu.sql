...
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`, `del_flag`) 
VALUES 
(2001, '协会概况', 2000, 1, 'about', 'cms/about/index', '', '1', '0', 'C', '0', '0', 'cms:about:list', 'list', 'admin', NOW(), 'admin', NOW(), '协会概况菜单', '0'),
(2002, '要闻动态', 2000, 2, 'news', 'cms/article/index', 'categoryCode=news', '1', '0', 'C', '0', '0', 'cms:article:list', 'list', 'admin', NOW(), 'admin', NOW(), '要闻动态菜单', '0'),
(2003, '党建工作', 2000, 3, 'party', 'cms/article/index', 'categoryCode=party', '1', '0', 'C', '0', '0', 'cms:article:list', 'list', 'admin', NOW(), 'admin', NOW(), '党建工作菜单', '0'),
(2004, '品牌活动', 2000, 4, 'activities', 'cms/article/index', 'categoryCode=activities', '1', '0', 'C', '0', '0', 'cms:article:list', 'list', 'admin', NOW(), 'admin', NOW(), '品牌活动菜单', '0'),
(2005, '表彰激励', 2000, 5, 'awards', 'cms/article/index', 'categoryCode=awards', '1', '0', 'C', '0', '0', 'cms:article:list', 'list', 'admin', NOW(), 'admin', NOW(), '表彰激励菜单', '0'),
(2006, '公告公示', 2000, 6, 'announcements', 'cms/article/index', 'categoryCode=notice', '1', '0', 'C', '0', '0', 'cms:article:list', 'list', 'admin', NOW(), 'admin', NOW(), '公告公示菜单', '0'),
(2007, '专题', 2000, 7, 'topics', 'cms/special/index', '', '1', '0', 'C', '0', '0', 'cms:special:list', 'list', 'admin', NOW(), 'admin', NOW(), '专题菜单', '0'),
(2008, '全国联动', 2000, 8, 'cooperation', 'cms/article/index', 'categoryCode=cooperation', '1', '0', 'C', '0', '0', 'cms:article:list', 'list', 'admin', NOW(), 'admin', NOW(), '全国联动菜单', '0'),
(2009, '网站导航', 2000, 9, 'navigation', 'cms/navigation/index', '', '1', '0', 'C', '0', '0', 'cms:navigation:list', 'list', 'admin', NOW(), 'admin', NOW(), '网站导航菜单', '0'),
(2010, '文章分类', 2000, 10, 'category', 'cms/category/index', '', '1', '0', 'C', '0', '0', 'cms:category:list', 'list', 'admin', NOW(), 'admin', NOW(), '文章分类菜单', '0'),
(2011, '轮播图管理', 2000, 11, 'banner', 'cms/banner/index', '', '1', '0', 'C', '0', '0', 'cms:banner:list', 'list', 'admin', NOW(), 'admin', NOW(), '轮播图管理菜单', '0'),
(2012, '焦点图管理', 2000, 12, 'focus', 'cms/focus/index', '', '1', '0', 'C', '0', '0', 'cms:focus:list', 'list', 'admin', NOW(), 'admin', NOW(), '焦点图管理菜单', '0'),
(2013, '友情链接', 2000, 13, 'link', 'cms/link/index', '', '1', '0', 'C', '0', '0', 'cms:link:list', 'list', 'admin', NOW(), 'admin', NOW(), '友情链接菜单', '0'),
(2014, '快捷链接', 2000, 14, 'quickLink', 'cms/quickLink/index', '', '1', '0', 'C', '0', '0', 'cms:quickLink:list', 'list', 'admin', NOW(), 'admin', NOW(), '快捷链接菜单', '0'),
(2015, '单页管理', 2000, 15, 'page', 'cms/page/index', '', '1', '0', 'C', '0', '0', 'cms:page:list', 'list', 'admin', NOW(), 'admin', NOW(), '单页管理菜单', '0'),
(2016, '网站配置', 2000, 16, 'siteConfig', 'cms/site-config/index', '', '1', '0', 'C', '0', '0', 'cms:siteConfig:list', 'list', 'admin', NOW(), 'admin', NOW(), '网站配置菜单', '0');
...
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`, `del_flag`) 
VALUES 
(2101, '协会概况查询', 2001, 1, '', '', '', '1', '0', 'F', '0', '0', 'cms:about:query', '#', 'admin', NOW(), 'admin', NOW(), '', '0'),
(2102, '协会概况新增', 2001, 2, '', '', '', '1', '0', 'F', '0', '0', 'cms:about:add', '#', 'admin', NOW(), 'admin', NOW(), '', '0'),
(2103, '协会概况修改', 2001, 3, '', '', '', '1', '0', 'F', '0', '0', 'cms:about:edit', '#', 'admin', NOW(), 'admin', NOW(), '', '0'),
(2104, '协会概况删除', 2001, 4, '', '', '', '1', '0', 'F', '0', '0', 'cms:about:remove', '#', 'admin', NOW(), 'admin', NOW(), '', '0'),
(2105, '文章查询', 2002, 1, '', '', '', '1', '0', 'F', '0', '0', 'cms:article:query', '#', 'admin', NOW(), 'admin', NOW(), '', '0'),
(2106, '文章新增', 2002, 2, '', '', '', '1', '0', 'F', '0', '0', 'cms:article:add', '#', 'admin', NOW(), 'admin', NOW(), '', '0'),
(2107, '文章修改', 2002, 3, '', '', '', '1', '0', 'F', '0', '0', 'cms:article:edit', '#', 'admin', NOW(), 'admin', NOW(), '', '0'),
(2108, '文章删除', 2002, 4, '', '', '', '1', '0', 'F', '0', '0', 'cms:article:remove', '#', 'admin', NOW(), 'admin', NOW(), '', '0'),
(2109, '专题查询', 2007, 1, '', '', '', '1', '0', 'F', '0', '0', 'cms:special:query', '#', 'admin', NOW(), 'admin', NOW(), '', '0'),
(2110, '专题新增', 2007, 2, '', '', '', '1', '0', 'F', '0', '0', 'cms:special:add', '#', 'admin', NOW(), 'admin', NOW(), '', '0'),
(2111, '专题修改', 2007, 3, '', '', '', '1', '0', 'F', '0', '0', 'cms:special:edit', '#', 'admin', NOW(), 'admin', NOW(), '', '0'),
(2112, '专题删除', 2007, 4, '', '', '', '1', '0', 'F', '0', '0', 'cms:special:remove', '#', 'admin', NOW(), 'admin', NOW(), '', '0'),
(2113, '导航查询', 2009, 1, '', '', '', '1', '0', 'F', '0', '0', 'cms:navigation:query', '#', 'admin', NOW(), 'admin', NOW(), '', '0'),
(2114, '导航新增', 2009, 2, '', '', '', '1', '0', 'F', '0', '0', 'cms:navigation:add', '#', 'admin', NOW(), 'admin', NOW(), '', '0'),
(2115, '导航修改', 2009, 3, '', '', '', '1', '0', 'F', '0', '0', 'cms:navigation:edit', '#', 'admin', NOW(), 'admin', NOW(), '', '0'),
(2116, '导航删除', 2009, 4, '', '', '', '1', '0', 'F', '0', '0', 'cms:navigation:remove', '#', 'admin', NOW(), 'admin', NOW(), '', '0');
...
(2, 2001), (2, 2002), (2, 2003), (2, 2004), (2, 2005), (2, 2006), (2, 2007), (2, 2008), (2, 2009), (2, 2010), (2, 2011), (2, 2012), (2, 2013), (2, 2014), (2, 2015), (2, 2016),
...
(2, 2105), (2, 2106), (2, 2107), (2, 2108),
(2, 2109), (2, 2110), (2, 2111), (2, 2112),
(2, 2113), (2, 2114), (2, 2115), (2, 2116),
