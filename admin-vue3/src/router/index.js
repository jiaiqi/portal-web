...
export const dynamicRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'banner',
        component: () => import('@/views/cms/banner'),
        name: 'Banner',
        meta: { title: '轮播图管理', icon: 'list' }
      },
      {
        path: 'focus',
        component: () => import('@/views/cms/focus'),
        name: 'Focus',
        meta: { title: '焦点图管理', icon: 'list' }
      },
      {
        path: 'notice',
      ...
      {
        path: 'link',
        component: () => import('@/views/cms/link'),
        name: 'Link',
      ...
      },
      {
        ...
        name: 'Page',
        meta: { title: '单页管理', icon: 'list' }
      },
      {
        path: 'quickLink',
        component: () => import('@/views/cms/quickLink'),
        name: 'QuickLink',
        meta: { title: '快捷链接', icon: 'list' }
      },
      {
        path: 'special',
        component: () => import('@/views/cms/special'),
        name: 'Special',
        meta: { title: '专题管理', icon: 'list' }
      }
    ]
  }
]
