...
const breadcrumbs = [
  ...
  { name: '协会章程', path: '/about/charter' }
]

const sideMenuItems = [
  { name: '协会概况', path: '/about', active: false, key: 'overview' },
  { name: '协会章程', path: '/about/charter', active: true, key: 'charter' },
...
onMounted(async () => {
  loading.value = true
  section.value = await getSectionByKey('charter')
  loading.value = false
})
</script>
          ...
          <div class="ant-tabs">
            <div class="ant-tabs-nav">
              <div class="ant-tabs-tab active">
                <div class="ant-tabs-tab-btn">协会章程</div>
              </div>
            </div>
          </div>
